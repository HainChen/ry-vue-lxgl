    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="性别" align="center" prop="sex" v-if="columns[2].visible" :show-overflow-tooltip="true" >
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="班级" prop="deptId">
              <treeselect v-model="form.deptId" :options="deptOptions" :show-count="true" placeholder="请选择班级" />
            </el-form-item>
          </el-col>
        </el-row>
